          ...
          <div className="digi-proc-header">
            <div className="digi-proc-title-group">
              ...
              <p style={{ fontSize: '0.75rem', color: '#cbd5e1', margin: 0 }}>
                {docConfig.titleEn} ({docConfig.titleTe}) • District: {structuredData.districtName?.value || 'Kurnool'} • Division: {structuredData.revenueDivision?.value || 'Kurnool'} • Mandal: {structuredData.mandalName?.value || 'Kallur'} • Village: {structuredData.villageName?.value || 'Lakshmipuram'} • Sachivalayam: {structuredData.sachivalayamName?.value || structuredData.villageName?.value || 'Lakshmipuram'}
              </p>
            </div>
